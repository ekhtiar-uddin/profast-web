...
import upload from "/src/assets/image-upload-icon.png";
        ...
        <div className="flex-1 pt-8 sm:pt-12 cw:pt-14 px-4 sm:px-8 cw:pl-14 cw:pr-0">
          ...
          <div className="w-full max-w-[400px] mx-auto mt-10 sm:mt-[65px] cw:mr-16">
            <form onSubmit={handleLogin} className=" rounded  ">
              ...
              <p className="text-[#000] mb-5">Register with Profast</p>

              <div className="my-5">
                <img loading="lazy" src={upload} alt="" />
              </div>

              <div>
                <h3 className="formLevel font-medium text-[#0F172A]">Name</h3>
                <input
                  type="text"
              ...
              <div>
                <h3 className="formLevel mb-3 font-medium text-[#0F172A]">
                  Passowrd
                </h3>
                <input
                  type="text"
              ...
              <p className=" font-medium  mb-3  text-[#71717A]   ">
                ...
                <Link to="/login">
                  <a className=" cursor-pointer text-p1"> Login </a>{" "}
                </Link>
              </p>
              <p className=" font-medium   text-[#71717A] text-center mb-3  ">
                Or
              </p>
            </form>
